...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="{{ route('reset-password') }}"
                                            class="text-main hover:text-main-hover dark:text-brand-400 text-sm">
                                            Forgot password?
                                        </a>
                                    </div>
                                    <!-- Button -->
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="text-main hover:text-main-hover dark:text-brand-400">Sign Up</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-[linear-gradient(to_bottom,#D9E7F6_43%,#B5CFED_100%)] relative hidden h-full w-full items-center lg:grid lg:w-1/2">
