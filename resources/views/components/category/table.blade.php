                        ...
                        <td
                            ...
                            <div class="flex items-center gap-4">
                                <div class="flex items-center justify-center">
                                    <i :data-lucide="category.icon" class="w-4 h-4 text-gray-900 dark:text-white"></i>
                                </div>
                                <div class="text-sm font-medium text-gray-900 dark:text-white" x-text="category.name">
                                </div>
                            </div>
                        </td>
                        <td
